...
GLuint Ex06TextureMix::CreateTexture(const std::string& InImagePath) 
{
...
void Ex06TextureMix::Start()
{
    applicationTime = 0;
    Program = new OGLProgram("resources/shaders/quadTexture.vert", "resources/shaders/quadMixTextures.frag");
...
void Ex06TextureMix::Update(float InDeltaTime)
{
